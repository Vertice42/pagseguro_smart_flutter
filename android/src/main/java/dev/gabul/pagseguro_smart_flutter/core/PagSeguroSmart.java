    ...
    public void initPayment(MethodCall call, MethodChannel.Result result) {
        ...
        if (call.method.equals(GET_DEFAULT_MESSAGE)) {
            ...
            if (eventCode == null) {
                ...
                result.success(this.payment.getDefaultMessage(eventCode));
            }
        }
        ...
        if (call.method.equals(PAYMENT_DEBIT)) {
            ...
            this.nfcPayment.writeNFCCard(call.argument("valor"),
                    call.argument("nome"),
                    call.argument("cpf"),
